...
internal class IosBibleVersionDownloadNotifier : BibleVersionDownloadNotifier {
    ...
    override suspend fun showProgress(versionId: String, versionName: String, progress: Float) {
        ...
        val content = UNMutableNotificationContent().apply {
            setTitle(str(en = "Downloading $versionName", pt = "Baixando $versionName", es = "Descargando $versionName"))
            setBody(
                if (percent > 0) str(
                ...
                else str(en = "Starting…", pt = "Iniciando…", es = "Iniciando…"),
            )
        }
    ...
    override suspend fun showError(versionId: String, versionName: String) {
        removeNotifications(listOf(progressId(versionId)))
        val content = UNMutableNotificationContent().apply {
            setTitle(str(en = "Error downloading $versionName", pt = "Erro ao baixar $versionName", es = "Error al descargar $versionName"))
            setBody(
                str(
