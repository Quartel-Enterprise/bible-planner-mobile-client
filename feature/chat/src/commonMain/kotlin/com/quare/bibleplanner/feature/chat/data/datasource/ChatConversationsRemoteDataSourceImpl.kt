...
internal class ChatConversationsRemoteDataSourceImpl(
    private val supabaseClient: SupabaseClient,
) : ChatConversationsRemoteDataSource {
    override suspend fun fetchAll(): List<ChatConversationDto> = supabaseClient
        .from(TABLE)
        .select {
            order(
