...
import com.quare.bibleplanner.core.user.domain.usecase.impl.CheckRemoteSessionStateUseCase
...
val userModule = module {
    ...
    factoryOf(::CheckRemoteSessionStateUseCase).bind<CheckRemoteSessionState>()
}
