...
internal open class ThrowingBibleVersionDao : BibleVersionDao {
    ...
    override suspend fun insertVersion(version: BibleVersionEntity): Unit = error("Unexpected call")

    override suspend fun updateVersion(version: BibleVersionEntity): Unit = error("Unexpected call")
    ...
    override suspend fun deleteVersion(id: String): Unit = error("Unexpected call")
}
