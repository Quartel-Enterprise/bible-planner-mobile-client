...
object AnalyticsEventNames {
    ...
    const val ACCOUNT_DELETE_CONFIRMED = "account_delete_confirmed"
    const val ACCOUNT_DELETE_CANCELLED = "account_delete_cancelled"
    ...
    const val EDIT_PROFILE_CLICKED = "edit_profile_clicked"
    const val PROFILE_AVATAR_CLICKED = "profile_avatar_clicked"
    const val EDIT_PROFILE_NAME_CLICKED = "edit_profile_name_clicked"
    const val EDIT_PROFILE_PHOTO_CLICKED = "edit_profile_photo_clicked"
    const val PROFILE_NAME_UPDATED = "profile_name_updated"
    const val PROFILE_PHOTO_SOURCE_SELECTED = "profile_photo_source_selected"
    ...
    const val VERSE_SELECTION_TOGGLED = "verse_selection_toggled"
    const val VERSE_SELECTION_CLEARED = "verse_selection_cleared"
    const val VERSE_HIGHLIGHT_APPLIED = "verse_highlight_applied"
    ...
    const val VERSE_SHARE_IMAGE_OPENED = "verse_share_image_opened"
    const val VERSE_SHARE_DISMISSED = "verse_share_dismissed"
    const val VERSE_SHARE_STYLE_CHANGED = "verse_share_style_changed"
    const val READER_APPEARANCE_OPENED = "reader_appearance_opened"
    const val READER_APPEARANCE_DISMISSED = "reader_appearance_dismissed"
    const val READER_FONT_SIZE_CHANGED = "reader_font_size_changed"
    ...
    const val READ_SIDE_PANEL_TOGGLED = "read_side_panel_toggled"
}
