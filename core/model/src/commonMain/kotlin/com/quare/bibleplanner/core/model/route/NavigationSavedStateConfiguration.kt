...
val navigationSavedStateConfiguration = SavedStateConfiguration {
    serializersModule = SerializersModule {
        polymorphic(NavKey::class) {
            ...
            subclass(DayReadingCompleteNavRoute::class, DayReadingCompleteNavRoute.serializer())
            subclass(DayStudyNavRoute::class, DayStudyNavRoute.serializer())
            subclass(DeleteAccountNavRoute::class, DeleteAccountNavRoute.serializer())
            ...
            subclass(EditNameNavRoute::class, EditNameNavRoute.serializer())
            subclass(EditPhotoSourceNavRoute::class, EditPhotoSourceNavRoute.serializer())
            subclass(EditPlanStartDateNavRoute::class, EditPlanStartDateNavRoute.serializer())
            subclass(EditProfileNavRoute::class, EditProfileNavRoute.serializer())
            subclass(ExpandedPhotoNavRoute::class, ExpandedPhotoNavRoute.serializer())
            ...
            subclass(ReaderAppearanceNavRoute::class, ReaderAppearanceNavRoute.serializer())
            subclass(DeleteHighlightColorNavRoute::class, DeleteHighlightColorNavRoute.serializer())
            subclass(VerseNoteNavRoute::class, VerseNoteNavRoute.serializer())
            subclass(VerseSelectionNavRoute::class, VerseSelectionNavRoute.serializer())
            subclass(ShareVerseNavRoute::class, ShareVerseNavRoute.serializer())
