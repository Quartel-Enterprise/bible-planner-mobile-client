...
- CI runs `./gradlew jvmTest` on every pull request, together with the coverage rules: 80% of the lines, for the merged report and for each new file — see [docs/code-quality.md](../code-quality.md#test-coverage).
