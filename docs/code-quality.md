...
| `*_Impl`, `$$serializer`, `ComposableSingletons`, `$DefaultImpls`, `BuildKonfig`, `*.generated.resources.*` | class filter | generated by Room, kotlinx.serialization, the Compose compiler, BuildKonfig and Compose Resources |
