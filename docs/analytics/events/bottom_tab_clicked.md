...
|---|---|---|---|
| `tab` | string | `plans` | Destination tab: `plans`, `books`, `profile` (derived from the `MainNavRouteDestination` the tap navigates to; `unknown` if an unrecognized route type is passed) |
