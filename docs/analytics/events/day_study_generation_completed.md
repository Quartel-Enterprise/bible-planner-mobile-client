...
- Completion while the day is backgrounded surfaces through the global floating card; the eventual day-study route open still logs [day_study_opened](day_study_opened.md).
