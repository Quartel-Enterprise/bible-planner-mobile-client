...
include(":core:image")
include(":core:verse_annotations")
...
include(":core:preferences:material_you")
include(":core:preferences:theme_selection")
include(":core:preferences:study_suggestion")
include(":core:in_app_update")
include(":core:day_study")
include(":feature:reading_plan")
include(":feature:day")
include(":feature:day_study")
include(":feature:day_reading_complete")
include(":feature:chat")
include(":feature:preferences:theme_selection")
include(":feature:preferences:study_suggestion")
include(":feature:material_you")
include(":feature:delete_progress")
include(":feature:delete_account")
